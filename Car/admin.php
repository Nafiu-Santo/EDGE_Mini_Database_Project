...
.board{
    ...
    .summary { display: flex; gap:50px; margin-left:350px; margin-bottom: 20px; }
    .summary-item { 
            background-color: black; 
            color: white; 
            padding: 20px; 
    ...
    .summary-item h3 { margin: 0; font-size: 2em; }
        ...
        .car_owner-summary { margin-bottom: 20px; width:}
        .car_owner-summary h3 { text-align: center; margin-bottom: 10px; }
        .car_owner-summary-table { width:100%; border-collapse: collapse; }
        .car_owner-summary-table th, .car_owner-summary-table td { border: 1px solid #ddd; padding: 8px; text-align: center; }
        .car_owner-summary-table th { background-color: #f2f2f2; }
...
<div class="summary">
    ...
    <?php
        ...
        foreach ($carTypes as $carType) {
            $sql = "SELECT COUNT(*) AS count FROM car_owner WHERE car_type='$carType'";
        ...
        <div class="car_owner-summary">
            <h3>Summary</h3>
            <table class="car_owner-summary-table">
                <thead>
                    <tr>
                        <th>Car Type</th>
                        <th>Total Cars</th>
